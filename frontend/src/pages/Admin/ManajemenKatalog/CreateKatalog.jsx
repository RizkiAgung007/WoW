      ...
      >
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col sm:flex-row-reverse sm:items-center sm:justify-between">
          <button
            type="submit"
            disabled={loading}
            className="flex items-center justify-center w-full sm:w-auto bg-[#3A6B4C] text-white font-semibold py-2.5 px-6 rounded-lg hover:bg-[#2c523a] transition-colors disabled:bg-[#3A6B4C]/50 cursor-pointer"
          >
